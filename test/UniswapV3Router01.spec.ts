...
describe('UniswapV3Router01', () => {
  ...
  let token0: Contract
  let token1: Contract
  let token0SW: Contract
  let token1SW: Contract
  let WETH: Contract
  ...
  beforeEach(async function() {
    ...
    token0SW = fixture.token0SW
    token1 = fixture.token1
    token1SW = fixture.token1SW
    WETH = fixture.WETH
    WETHPartner = fixture.WETHPartner
    factory = fixture.factoryV2
    router = fixture.router03
    pair = fixture.pair
    pairSW = fixture.pairSW
    WETHPair = fixture.WETHPair
    WETHPairSW = fixture.WETHPairSW
  ...
  describe('UniswapV3Router01', () => {
    ...
    async function addLiquidity(token0Amount: BigNumber, token1Amount: BigNumber, wallet: Wallet) {
    ...
    describe('swapExactTokensForTokens', () => {
      ...
      beforeEach(async () => {
        ...
        // console.log(token0SW);
        await token0SW.approve(router.address, MaxUint256)
      })
      ...
      it('happy path', async () => {
        await expect(
          router.swapExactTokensForTokens(
            swapAmount,
            0,
            [token0SW.address, token1SW.address],
            secondaryWallet.address,
            MaxUint256,
            overrides
          )
        )
          .to.emit(token0SW, 'Transfer')
          .withArgs(secondaryWallet.address, pairSW.address, swapAmount)
          .to.emit(token1SW, 'Transfer')
          .withArgs(pairSW.address, secondaryWallet.address, expectedOutputAmount)
          .to.emit(pairSW, 'Sync')
